...
<header class="bg-white border-b border-gray-200 sticky top-0 z-40">
    <div class="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
        <a href="/pages/student/dashboard.php" class="flex items-center gap-2 eduattend-brand">
            <span class="material-symbols-outlined text-emerald-600">school</span>
            <span><?= htmlspecialchars(Assets::APP_NAME) ?></span>
        </a>
        <nav class="hidden md:flex items-center gap-1 flex-wrap justify-end">
            <?php foreach (Assets::studentNavItems() as $item): ?>
                <?php
            ...
            <?php endforeach; ?>
            <a class="eduattend-nav-link text-red-600" href="/pages/student/logout.php">
